...
var gulp             = require('gulp'), // gulp core.
    ...
    extender         = require('gulp-html-extend'), // HTML includes.
...
gulp.task('archive', function () {
  ...
  var now = new Date(),
      date = now.getFullYear() + '-' + ('0' + (now.getMonth() + 1)).slice(-2) + '-' + ('0' + now.getDate()).slice(-2) + '__' + ('0' + (now.getHours() + 1)).slice(-2) + 'h' + (now.getMinutes() + 1).slice(-2),
